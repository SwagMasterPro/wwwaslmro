        ...
        <div className="container-wide relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p 
                className="text-base md:text-xl mb-8 leading-relaxed max-w-xl"
            ...
            {/* The supplied visual includes Romanian labels, so it is intentionally RO-only. */}
            {!isEnglish ? (
      ...
      <section className="section-lg surface-tertiary">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {localizedMemberBenefits.map((item) => (
              <div
                key={item.title}
