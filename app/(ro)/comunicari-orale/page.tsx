        ...
        <div className="container-default">
          ...
          >
            ...
            <h1 className="text-display text-white mb-6" style={{ fontSize: "clamp(2rem, 5vw, 3rem)" }}>
              Comunicări Orale 2026 — arhivă
            </h1>
            <p className="text-lg leading-relaxed" style={{ color: 'rgba(255, 255, 255, 0.85)' }}>
              Instrucțiunile și calendarul ediției încheiate
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container-default">
          ...
          >
            <div className="space-y-8">
              <div className="card p-6 border border-[var(--color-primary-200)] bg-[var(--color-primary-50)]">
                <p className="text-body mb-4">
                  Apelul pentru comunicări orale din 2026 s-a încheiat. Păstrăm instrucțiunile ca arhivă pentru autorii și participanții ediției.
                </p>
                <Link href="/evenimente" className="font-semibold text-[var(--color-primary-700)] hover:underline">
                  Vezi evenimentele și apelurile ASLM actuale
                </Link>
              </div>
              {/* Intro */}
              <div className="card p-8 bg-[var(--color-primary-50)]">
                <p className="text-body mb-4">
                  Autorii și coautorii comunicărilor orale au beneficiat de <strong>credite suplimentare</strong>,
                ...
                <div className="space-y-6 ml-16">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-body">
                        Termenul de transmitere a fost <strong>10 martie 2026</strong>.
                      </p>
                    </div>
                  </div>
              ...
              <div className="card p-8">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-body mb-4">
                      Lucrările acceptate de Comitetul Științific au fost confirmate autorilor prin e-mail
                      și incluse în <strong>Volumul de rezumate al Conferinței</strong>.
                    </p>
                    <p className="text-body mb-4">
