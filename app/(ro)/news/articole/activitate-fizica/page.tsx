...
export default function ActivitateFizicaPage() {
  const category = getCategoryBySlug("activitate-fizica")!;
  const articles = getArticlesByCategory("activitate-fizica");
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateWebPageSchema(
              "https://www.aslm.ro/news/articole/activitate-fizica",
              "Activitate Fizică | Articole ASLM",
              ...
              [
                ...
                { name: "Activitate Fizică", path: getNewsCategoryPath("activitate-fizica") },
              ]
            )
          ),
        }}
