...
export default function GestionareStresPage() {
  ...
  const articles = getArticlesByCategory("gestionare-stres");
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateWebPageSchema(
              "https://www.aslm.ro/news/articole/gestionare-stres",
              "Gestionare Stres | Articole ASLM",
              ...
              [
                ...
                { name: "Gestionare Stres", path: getNewsCategoryPath("gestionare-stres") },
              ]
            )
          ),
        }}
