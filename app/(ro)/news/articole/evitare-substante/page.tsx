...
export default function EvitareSubstantePage() {
  const category = getCategoryBySlug("evitare-substante")!;
  const articles = getArticlesByCategory("evitare-substante");
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateWebPageSchema(
              "https://www.aslm.ro/news/articole/evitare-substante",
              "Evitare Substanțe Nocive | Articole ASLM",
              ...
              [
                ...
                { name: "Evitare Substanțe Nocive", path: getNewsCategoryPath("evitare-substante") },
              ]
            )
          ),
        }}
