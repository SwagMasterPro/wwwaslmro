...
export default function CalitateSomnPage() {
  ...
  const articles = getArticlesByCategory("calitate-somn");
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            generateWebPageSchema(
              "https://www.aslm.ro/news/articole/calitate-somn",
              "Calitate Somn | Articole ASLM",
              ...
              [
                ...
                { name: "Calitate Somn", path: getNewsCategoryPath("calitate-somn") },
              ]
            )
          ),
        }}
